...
public class HomeScreenFrontEnd extends JFrame {
...
/*	public static void main(String[] args) {
		HomeScreenFrontEnd frame = new HomeScreenFrontEnd(new User());
	...
	public HomeScreenFrontEnd(User usrData) {
		...
		btnCancel_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HomeScreenFrontEnd home = new HomeScreenFrontEnd(usrData);
				setVisible(false);
				...
				if (e.getSource() == btnGenerate) {
					if (customer.equals("--Select User--")
						...
						if ((!selectAccountList.getSelectedItem().toString().isEmpty())
								&& (!selectAccountList.getSelectedItem().toString().equals("--Select Account--"))) {
							TransactionDao trans = new TransactionDao();
							result = trans.fetchUserTransaction(selectAccountList.getSelectedItem().toString(),
									customer);
		...
		btnCancel_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HomeScreenFrontEnd home = new HomeScreenFrontEnd(usrData);
				setVisible(false);
				home.setVisible(true);
		...
		internalPanelclientTran.add(btnCancel_5);
